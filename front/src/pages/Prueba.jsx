...
const Product3 = () => {
  ...
  return (
    <div className="md:flex items-start justify-center py-6 md:py-12 2xl:px-20 md:px-6 px-4">
      <div className="w-full md:w-2/5 lg:w-2/5 xl:w-2/6 mb-6 md:mb-0 md:block hidden">
        <img
      ...
      <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6">
